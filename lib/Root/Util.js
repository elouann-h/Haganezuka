...
exports.Colors = exports.extractString = exports.readEmbeds = exports.SFToCtxChannel = exports.SFToUser = exports.SFToMember = exports.timeout = exports.split = exports.err = exports.test = exports.log = void 0;
 ...
 */
function log(...args) {
    console.log('⟦HAGANEZUKA LOG⟧', ...args.map((arg) => arg.message || arg));
}
exports.log = log;
/**
 ...
 */
function test(...args) {
    console.log('⟦HAGANEZUKA TEST⟧', ...args.map((arg) => arg.message || arg));
}
exports.test = test;
/**
 ...
 */
function err(...args) {
    console.error('⟦HAGANEZUKA ERROR⟧', ...args.map((arg) => arg.message || arg));
}
exports.err = err;
/**
