...
const BreathingStyles_1 = require("./BreathingStyles");
const bloodDemonArts = [
    ...
    },
    {
        ...
        moves: BreathingStyles_1.default.find((style) => style.id === 'moon').moves,
        movesCategories: BreathingStyles_1.default.find((style) => style.id === 'moon').movesCategories,
    },
];
exports.default = bloodDemonArts;
