...
const data = {
    ...
    execute: async (client, interaction, ctx) => {
        ...
        await ctx.edit(`Vous êtes désormais un adepte l'ensemble de techniques **« ${artInfos.name} »**.<:color:GREEN>`, artMessage);
